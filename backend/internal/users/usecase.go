...
type UserUseCaseI interface {
	...
	SignIn(ctx context.Context, email string, password string) (string, string, *models.User, error)
	...
	Refresh(ctx context.Context, refreshToken string) (string, string, *models.User, error)
